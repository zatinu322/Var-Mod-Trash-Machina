...
function CreateNewDummyObject(modelName, objName, parentId, belong, pos, rot,skin)
	...
	local rand_dweller = 0

	if skin == nil then skin = 0 end

	if rand_dweller == 1 then
		local dweller_list = {"dweller", "dweller2", "dweller3", "dweller_player", 
		                      "dweller_father", "dweller_lisa", "dweller_felix", 
							  "dweller_ben", "dweller_axel", "dweller_white", 
							  "dweller_brodyaga"}
...
function CheckPlayerVehicle()
	...
	if vehPlayer then vehPlayer:Remove() end
end
