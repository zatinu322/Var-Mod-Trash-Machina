...
--éêìÜàÖ
	...
	local smallgun={"hornet01","specter01","pkt01","kord01","maxim01","storm01",
	                "fagot01", "rapier01","vector01","vulcan01","flag01","kpvt01",
					"rainmetal01","elephant01","odin01","bumblebee01","omega01",
					"cyclops01","octopus01","hurricane01","rocketLauncher","big_swingfire01"}
